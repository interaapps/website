<template>
<div class="contents"><br><br><br><br><br><br><br><br><br><br>
<h1 style="text-align:center;margin-bottom: 50px;">Donate</h1>
    ...
    <i id="heart-symbole" class="material-icons">favorite_border</i><br><br><br><br><br><br>
    </div>
</template>
